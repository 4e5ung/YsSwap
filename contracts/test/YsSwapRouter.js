...
describe("YsSwapRouter", function () {
    ...
    it("swapExactTokensForTokens", async function() {
        ...
        // swap estimate price
        let amountOuts = await swapRouterContract.getSwapAmountsOut(ethers.utils.parseEther("1.0"), [mockToken0Contract.address, mockToken1Contract.address]);
    ...
    it("swapTokensForExactTokens", async function() {
        ...
        // swap estimate price
        amountsIn = await swapRouterContract.getSwapAmountsIn( 5000, [mockToken0Contract.address, mockToken1Contract.address])
    ...
    it("swapExactTokensForETH", async function() {   
        ...
        // swap estimate price
        let amountOuts = await swapRouterContract.getSwapAmountsOut(5000, [mockToken0Contract.address, WMATICContract.address]);
    ...
    it("swapTokensForExactETH", async function() {
        ...
        // swap estimate price
        let amountsIn = await swapRouterContract.getSwapAmountsIn(5000, [mockToken0Contract.address, WMATICContract.address]);
    ...
    it("swapExactETHForTokens", async function() {
        ...
        // swap estimate price
        let amountOuts = await swapRouterContract.getSwapAmountsOut(5000, [WMATICContract.address, mockToken0Contract.address]);
    ...
    it("swapETHForExactTokens", async function() {
        ...
        // swap estimate price
        let amountsIn = await swapRouterContract.getSwapAmountsIn(5000, [WMATICContract.address, mockToken0Contract.address]);
    ...
    it("getSwapAmountsIn", async function() {
        expect(await swapRouterContract.getSwapAmountsIn( 
            5000, 
            [mockToken0Contract.address, mockToken1Contract.address]
            )
        ).to.deep.eq([ethers.BigNumber.from(10031), ethers.BigNumber.from(5000)]);
    });


    it("getSwapAmountsOut", async function() {
        expect(await swapRouterContract.getSwapAmountsOut(
            1000, 
            [mockToken0Contract.address, mockToken1Contract.address]
            )
        ).to.deep.eq([ethers.BigNumber.from(1000), ethers.BigNumber.from(498)]);
    });
});
